...
class CanvasCourse extends CanvasModel
{
	...
	public static function load($init)
	{
		...
		{
			throw new CanvasException('Invalid initialization parameters for loading course data');
		}
	...
	public function publish()
	{
		// Make a put request 
		$client = self::_getClient();
		$client->setMethod(CanvasClient::PUT);
	...
	public function getGrades($includeMuted = true)
	{
		if(null === $this->grades)
		{
			...
			$uri .= 'access_token='.CanvasClient::$apiConfig['apiKey'];
			...
			foreach ($data as $datum)
			{
				...
				$grades[$datum['user_id']] 	= new CanvasGrade($grade, $student, $this);
			}
	...
	*/
	...
	public function getGradeForStudent(CanvasUser $student)
	{
