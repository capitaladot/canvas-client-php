...
class CanvasAccount extends CanvasModel
{
	public $id;
	public $name;
	...
	public static function load($init)
	{
		...
		{
			throw new CanvasException('Invalid account initialization parameters');
		}
